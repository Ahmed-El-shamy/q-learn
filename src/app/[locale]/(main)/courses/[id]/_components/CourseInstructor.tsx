        ...
        <div>
            ...
            <div className="relative">
                ...
                <div className="relative z-[1] rounded-lg bg-white flex flex-col lg:flex-row justify-center items-center px-3 sm:px-5 md:px-8 py-2.5 sm:py-3">
                    <div className="w-full lg:w-2/3 flex flex-col sm:flex-row gap-2 sm:gap-3 px-0 sm:px-1.5 md:px-3 text-green-600 lg:border-e lg:border-e-green-600 pb-3 lg:pb-0">
                        {data?.avatar && (
                            <Avatar 
                                src={data.avatar}
                    ...
                    <div className="w-full lg:w-1/3 flex flex-row lg:flex-col gap-2 sm:gap-3 ps-0 lg:ps-3 justify-center lg:justify-start">
                        {stats.map((stat) => (
                            <div key={stat.label} className="flex items-center gap-1.5 sm:gap-2 text-green-600">
