...
export const mockCourses: Course[] = [
    {
        ...
        level: "Beginner",
        details: "Learn full stack web development using MongoDB, Express, React, and Node.js",
        price: 5.0,
        oldPrice: 417.0,
        rating: 0,
        students: 1,
    ...
    },
    {
        ...
        level: "Intermediate",
        details: "Comprehensive English language course designed for quick learning",
        price: 5.0,
        oldPrice: 229.0,
        rating: 0,
        students: 1,
    ...
    },
    {
        ...
        level: "Beginner",
        details: "Complete Laravel framework course for building modern web applications",
        price: 154.0,
        oldPrice: 313.0,
        rating: 0,
        students: 1,
    ...
    return (
        <section className="flex flex-col gap-4 sm:gap-5 md:gap-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-primary">Students Also Bought</h2>
                <p className="text-xs sm:text-sm text-gray-600">More courses you might like</p>
            </div>
