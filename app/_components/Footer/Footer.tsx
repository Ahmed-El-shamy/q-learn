                                ...
                                <div className="flex flex-col gap-2">
                                    {section.links.map((link) => (
                                        <Link
                                            key={link.label}
                                            href={link.link}
                                            className="relative after:absolute w-fit after:bottom-0 after:left-0 after:h-px after:bg-black after:w-0 hover:after:w-full after:transition-all after:duration-300 after:ease-out"
                                        >
                                            {link.label}
                                        </Link>
                                    ))}
